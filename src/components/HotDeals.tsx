  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ marginBottom: '8px' }}>O</span>
        T
        {'\u00A0'}
      </p>
      <p
      ...
      >
        ...
        <span style={{ marginBottom: '8px' }}>L</span>
        S
...
function TextLinesSection({ handleTextLineClick, currentSection }) {
  const [hoveredLine, setHoveredLine] = useState(null);

  const handleTextLineMouseEnter = (line) => {
    setHoveredLine(line);
  };
      ...
      <div style={{ marginBottom: '25px' }}>
        <p
          style={{
            fontSize: '16px',
            margin: '0',
            color: currentSection === 40 ? 'red' : hoveredLine === 40 ? 'red' : 'black',
            cursor: 'pointer',
          }}
      ...
      <div style={{ marginBottom: '25px' }}>
        <p
          style={{
            fontSize: '16px',
            margin: '0',
            color: currentSection === 50 ? 'red' : hoveredLine === 50 ? 'red' : 'black',
            cursor: 'pointer',
          }}
      ...
      <div style={{ marginBottom: '25px' }}>
        <p
          style={{
            fontSize: '16px',
            margin: '0',
            color: currentSection === 60 ? 'red' : hoveredLine === 60 ? 'red' : 'black',
            cursor: 'pointer',
          }}
      ...
      <div>
        <p
          style={{
            fontSize: '16px',
            margin: '0',
            color: currentSection === 70 ? 'red' : hoveredLine === 70 ? 'red' : 'black',
            cursor: 'pointer',
          }}
