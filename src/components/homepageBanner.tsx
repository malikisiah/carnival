                ...
                <div className="flex w-1/3 flex-wrap">
                    <div className="w-full p-1 md:p-2 relative">
                        <a className="" href="">
                            ...
                            src="/img/homepageBannerImg1.jpg" />
                        </a>
                    </div>
                </div>
                <div className="flex w-1/3 flex-wrap">
                    <div className="w-full p-1 md:p-2">
                        ...
                        <img
                            alt="gallery"
                            className="block h-full w-full  object-cover object-center"
                            src="/img/homepageBannerImg2.jpg" />
                        </a>
                    </div>
                </div>
                <div className="flex w-1/3 flex-wrap">
                    <div className="w-full p-1 md:p-2">
                        ...
                        <img
                            alt="gallery"
                            className="block h-full w-full  object-cover object-center"
                            src="/img/homepageBannerImg3.jpg" />
                        </a>
                    </div>
                </div>
                <div className="flex w-1/3 flex-wrap">
                    <div className="w-full p-1 md:p-2">
                        ...
                        <img
                            alt="gallery"
                            className="block h-full w-full object-cover object-center"
                            src="/img/homepageBannerImg4.jpg" />
                        </a>
                    </div>
                </div>
                <div className="flex w-1/3 flex-wrap">
                    <div className="w-full p-1 md:p-2">
                        ...
                        <img
                            alt="gallery"
                            className="block h-full w-full object-cover object-center"
                            src="/img/homepageBannerImg5.jpg" />
                        </a>
                    </div>
                </div>
                <div className="flex w-1/3 flex-wrap">
                    <div className="w-full p-1 md:p-2">
                        ...
                        <img
                            alt="gallery"
                            className="block h-full w-full object-cover object-center"
                            src="/img/homepageBannerImg6.jpg" />
                        </a>
                    </div>
                </div>
            </div>
