      ...
      <div id="block-container" className="flex flex-col">
        ...
        >
          ...
          <div className="flex p-2 space-x-2">
            ...
            <div className="border-r border-gray-900 pr-2">FOR WOMEN</div>
            <div className="border-r border-gray-900 pr-2">FOR MEN</div>
            <div className="border-r border-gray-900 pr-2">FOR KIDS</div>
            <div>ACCESSORIES</div>
          </div>
        </div>
