    ...
    return (
      <div>
        {user ? (
          <div>
            <p>
            Hello <span style={usernameStyle}>{user.displayName}</span> (not <span style={usernameStyle}>{user.displayName}</span> ?{" "}
            <span onClick={handleSignOut} style={linkStyle}>Logout</span>)
            </p>
            {/* Add your dashboard content and widgets here */}
            <p style={marginStyle}>
            From your account you can view{" "}
            <a href="#" style={linkStyle}>recent orders</a>, manage{" "}
            <a href="#" style={linkStyle}>shipping and billing addresses</a>, and edit your
            <a href="#" style={linkStyle}>password and account details.</a>
          </p>
          <VendorElement />
          </div>
        ) : (
    ...
    return (
      <div style={vendorStyle}>
        <div style={textContainerStyle}>
          ...
          <div style={textUnderHeaderStyle}>Vendors can sell products and manage a store with a vendor dashboard.</div>
        </div>
